...
public class AppConstants {
     ...
     * for the application
     */
    static final String APP_KEY_SECRET = "7d3d3b6c2d3683bf25bbb51533ec60lat";
    public static final String INVITE_MESSAGE_SMS = "Hello get " + getInstance().getString(R.string.app_name) + " so we can easily chat  with each other !  ";
    public static final String JOINED_MESSAGE_SMS = "Hi there! i'm using " + getInstance().getString(R.string.app_name);
    /**
